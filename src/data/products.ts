...
export const PRODUCT_SEEDS: ProductSeed[] = [
  {
    ...
    keyParams: ["20 boards/box", "220V ~100W", "55×38×16 cm", "USB + OTG/LAN", "1 PC → 3–5 boxes"],
    features: [
  ...
  },
  {
    ...
    keyParams: ["220V input", "Centralized bus", "Replacement part", "OEM cabinets", "7×24 design"],
