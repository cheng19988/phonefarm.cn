...
export const metadata = buildMetadata({
  ...
  description: "Guangzhou Phone Farm admin panel",
  path: "/admin",
  noIndex: true,
});
      ...
      <div className="container-wide">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {[
            ...
            { label: "RFQ inquiries", value: contacts },
        ...
        <section className="mb-12">
          ...
          <p className="text-xs text-slate-500 mt-4">Bulk edits: run <code className="text-slate-400">npx prisma studio</code></p>
        </section>
      </div>
    </div>
  );
